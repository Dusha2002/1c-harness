...
- Основная инфобаза — источник реальных пользовательских данных только на чтение через runtime-инструменты. Не записывай туда автономно. Изменённый код и конфигурация проверяются только в staging/sandbox.
