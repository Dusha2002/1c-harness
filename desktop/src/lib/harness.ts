...
export interface Progress { type: string; tool?: string; result?: string; iteration?: number; operation?: string; message?: string; elapsed_seconds?: number | null; files?: number }
